    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-purple-50/30 p-8">
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-gray-600 mt-1">Administra los servicios que ofreces</p>
        </div>
        <button 
              ...
              <div className="relative h-48 overflow-hidden">
                <img
                  ...
                  onError={(e) => {
                    ...
                    target.src = "https://images.unsplash.com/photo-1560750588-73207b1ef5b8?w=400&h=300&fit=crop&q=80";
                  }}
                />
      ...
      {filteredServices.length === 0 && (
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-16 text-center">
          ...
          <button
            onClick={handleCreate}
            className="px-6 py-3 bg-gradient-to-r from-purple-600 to-fuchsia-600 text-white font-semibold rounded-xl hover:shadow-lg hover:shadow-purple-500/50 transition-all inline-flex items-center gap-2"
          >
            <Plus className="w-5 h-5" strokeWidth={2.5} />
            Crear Servicio
          </button>
                ...
                <div className="md:col-span-2">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      min={0}
                      step={100}
                      className="w-full pl-8 pr-4 py-3 bg-gray-50 border-2 border-gray-200 rounded-xl focus:bg-white focus:border-purple-300 focus:ring-4 focus:ring-purple-100 outline-none transition-all"
                    />
                  </div>
                </div>
